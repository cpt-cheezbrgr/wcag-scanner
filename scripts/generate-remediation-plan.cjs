...
const sites = [
  ...
  },
  {
    ...
    pages: 1261, violations: 15, critical: 7, serious: 8,
    score: 100, instances: 1261, heuristics: 5105,
    violations_detail: [
      { id: 'color-contrast',         impact: 'SERIOUS',  pages: 329,  wcag: '1.4.3', help: 'Elements must meet minimum color contrast ratio thresholds' },
      { id: 'frame-title',            impact: 'SERIOUS',  pages: 53,   wcag: '2.4.1', help: 'Frames and iframes must have an accessible name' },
      { id: 'button-name',            impact: 'CRITICAL', pages: 50,   wcag: '4.1.2', help: 'Buttons must have discernible text (YouTube player buttons)' },
      { id: 'aria-prohibited-attr',   impact: 'SERIOUS',  pages: 47,   wcag: '4.1.2', help: 'Elements must only use permitted ARIA attributes (YouTube)' },
      { id: 'link-name',              impact: 'SERIOUS',  pages: 38,   wcag: '2.4.4', help: 'Links must have discernible text (empty card links)' },
      { id: 'select-name',            impact: 'CRITICAL', pages: 24,   wcag: '4.1.2', help: 'Select elements must have accessible names' },
      ...
      { id: 'list',                   impact: 'SERIOUS',  pages: 14,   wcag: '1.3.1', help: 'ul/ol must only directly contain li elements' },
      { id: 'listitem',               impact: 'SERIOUS',  pages: 9,    wcag: '1.3.1', help: 'li elements must be in a ul or ol' },
      { id: 'image-alt',              impact: 'CRITICAL', pages: 7,    wcag: '1.1.1', help: 'Images must have alternative text' },
...
function buildDoc() {
  ...
  children.push(
    ...
    p('This report presents the findings of an automated WCAG 2.1 Level AA accessibility scan conducted across 19 Trinity Health system websites. Scans were performed using the axe-core accessibility engine combined with custom heuristic checks, crawling a total of 35,855 pages.'),
    p(''),
      ...
      rows: [
        ...
        new TableRow({
          children: [
            ...
            dataCell('35,855', 1200, { bold: true, fill: LIGHT_BLUE, align: AlignmentType.CENTER }),
            dataCell('102', 1200, { bold: true, fill: LIGHT_BLUE, align: AlignmentType.CENTER, color: RED }),
            dataCell('153', 1100, { bold: true, fill: LIGHT_BLUE, align: AlignmentType.CENTER, color: ORANGE }),
            dataCell('255', 1100, { bold: true, fill: LIGHT_BLUE, align: AlignmentType.CENTER }),
